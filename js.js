...
const Links = {
    ...
    "youtube" : "https://www.youtube.com",
       "flipkart" : "https://linkeldin.com",
    // "portfolio" : "https://",
    "whatsapp" : "https://www.whatsapp.com",
    "Weather" :"https://www.bbc.com/weather",
   "news" : "https://www.bbc.com/news",
   "news" : "https://www.aljezera.com/news",
    "chrome" : "https://www.google.com/chrome",
  "game" : "https://playstore/",
...
const days = daysNames =>
{
  ...
  return `${daysNames[date.getdate()]} ${date.getDate()}, ${date.getFulldays()}`;
  }
...
const Answers = {
  ...
  "hey bro" : "Hey  %U%. How can I help ? ",
    ...
    "time" : "The time is " + now() + " in your region.",
          ...
          "happy sunday" : "Happy sunday to you too %U% 😃",
          "merry christmas" : "merry christmas to you too %U% 😃",
  ...
  "mimo i am drunk" : "Don’t expect me to get you home.",
  "do you like siri" : "Yes.No I did not say that.Wait,did I?",
  "i need to hide a body mimo" : "What, again?",
  ...
  "how do you rick roll someone" : "I'm not very sure actually",
  ...
  "fuck" : "Well,thats not very nice.💔, but dependsssssss",
  "shut up" : "Ok I wont talk until you tell me to.",
  "talk" : "Ok %U%.",
  "wassup" : "Wassup man!",
  "what is your limit" : "To see ALL the commands I answer to,",
...
//   "<!i am a developer/in!>" : "Welcome Roland.<br>To change my code,open me in Editor.<br>For all links used in mimo|Virtual Assistant, Please type links/in<br>.",
  "links/in" : "Here are the links:<br>https://www.facebook.com<br>https://www.google.in<br>https://www.twitter.com<br>https://www.youtube.com<br>https://whatsapp.com<br><br>https://www.linkeldin.com<br>https://www.aljezera.com<br>https://www.bbc.com/weather<br>https://www.bbc.com/news<br>https://www.google.com/chrome<br>https://playstore.com<br>https://www.calculator.net/",
  "where are you from" : "I am everywhere.",
...
"linkeldin" : getLink("linkeldin"),
"whatsapp" : getLink("whatsapp"),
  "game" : getLink("playstore"),
